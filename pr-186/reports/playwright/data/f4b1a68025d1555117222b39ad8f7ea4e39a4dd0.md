...
- Name: integration/events/delete-event.spec.ts >> Events - delete >> admin can delete an event and it no longer appears in the list
- Location: tests/integration/events/delete-event.spec.ts:14:9
