...
class TicketTest {
    ...
    void ticketCode(boolean caseInsensitive) {
        ...
        var modifiedCase = Ticket.generateHmacTicketInfo(
                "eventKey", caseInsensitive, fullName.toUpperCase(), email.toUpperCase(), "id", "uuid");
    ...
    @ValueSource(
            strings = {
                ...
                "Ç/ç,Ğ/ğ,I/i,İ/i,J/j,Ö/ö,Ş/ş,Ü/ü", // turkish https://en.wikipedia.org/wiki/Turkish_alphabet, except
                // character ı, see NameNormalizer
    ...
    void validateCase(String letters) {
        ...
        var unmodifiedLowercase = Ticket.generateHmacTicketInfo(
                "eventKey", false, lowercase.toString(), "mail@example.org", "id", "uuid");
        var processedUppercase =
                Ticket.generateHmacTicketInfo("eventKey", true, uppercase.toString(), "mail@example.org", "id", "uuid");
    ...
    void ticketCodeUTF8Chars(boolean caseInsensitive) {
        ...
        var regularCase = Ticket.generateHmacTicketInfo("eventKey", caseInsensitive, fullName, email, "id", "uuid");
        var modifiedCase = Ticket.generateHmacTicketInfo(
                "eventKey", caseInsensitive, fullNameSwappedCase, email.toUpperCase(), "id", "uuid");
        assertEquals(caseInsensitive, regularCase.equals(modifiedCase));
    }
}
