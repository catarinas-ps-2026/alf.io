...
public class RequestUtilsTest {
    ...
    @Test
    public void testUA() {
        Assertions.assertTrue(RequestUtils.isSocialMediaShareUA(
        ...
        Assertions.assertTrue(
                RequestUtils.isSocialMediaShareUA("Slackbot-LinkExpanding 1.0 (+https://api.slack.com/robots)"));
        Assertions.assertFalse(
                RequestUtils.isSocialMediaShareUA(
