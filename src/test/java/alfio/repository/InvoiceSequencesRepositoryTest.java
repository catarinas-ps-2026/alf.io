...
class InvoiceSequencesRepositoryTest {
    ...
    private final InvoiceSequencesRepository invoiceSequencesRepository =
            mock(InvoiceSequencesRepository.class, withSettings().defaultAnswer(CALLS_REAL_METHODS));

    @Test
    void testLockSequenceForUpdateDefault() {
        when(invoiceSequencesRepository.lockSequenceForUpdate(123, BillingDocument.Type.INVOICE))
                .thenReturn(10);
    ...
    void testIncrementSequenceForDefault() {
        when(invoiceSequencesRepository.incrementSequenceFor(123, BillingDocument.Type.INVOICE))
                .thenReturn(1);
