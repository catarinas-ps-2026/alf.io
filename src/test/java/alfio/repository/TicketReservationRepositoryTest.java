...
class TicketReservationRepositoryTest {
    ...
    private final TicketReservationRepository ticketReservationRepository =
            mock(TicketReservationRepository.class, withSettings().defaultAnswer(CALLS_REAL_METHODS));

    @Test
    void testCountTicketsInReservationForCategories_Empty() {
        when(ticketReservationRepository.countTicketsInReservationNoCategories("res1"))
                .thenReturn(5);

        Integer result =
                ticketReservationRepository.countTicketsInReservationForCategories("res1", Collections.emptyList());
    ...
    void testCountTicketsInReservationForCategories_WithCategories() {
        ...
        when(ticketReservationRepository.countTicketsInReservationForExistingCategories("res1", categories))
                .thenReturn(3);
