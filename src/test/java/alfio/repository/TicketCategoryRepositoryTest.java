...
class TicketCategoryRepositoryTest {
    ...
    private final TicketCategoryRepository ticketCategoryRepository =
            mock(TicketCategoryRepository.class, withSettings().defaultAnswer(CALLS_REAL_METHODS));
    ...
    void testFindStatisticsForEventIdByCategoryId() {
        ...
        Map<Integer, TicketCategoryStatisticView> result =
                ticketCategoryRepository.findStatisticsForEventIdByCategoryId(1);
        assertEquals(2, result.size());
