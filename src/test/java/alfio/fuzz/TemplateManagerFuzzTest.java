...
public class TemplateManagerFuzzTest {
    ...
    public void fuzzTranslateWithLocales(FuzzedDataProvider data) {
        try {
            String template = data.consumeString(2000);
            Locale[] locales = {Locale.ITALIAN, Locale.GERMAN, Locale.FRENCH, Locale.forLanguageTag("pt-BR"),
                Locale.forLanguageTag("nl-NL"), Locale.forLanguageTag("ro-RO"), Locale.forLanguageTag("tr-TR"),
                Locale.forLanguageTag("pl-PL"), Locale.forLanguageTag("da-DK"), Locale.forLanguageTag("bg-BG"),
                Locale.forLanguageTag("sv-SE"), Locale.forLanguageTag("cs-CZ"), Locale.forLanguageTag("es-ES")};
