...
interface FieldRepository {
    ...
    @Query(
        ...
        """)
    @AutoGeneratedKey("id")
    AffectedRowCountAndKey<Long> insertConfiguration(
    ...
    @Query(
        ...
        """)
    int upsertDescription(
            @Bind("configurationId") long configurationId,
            @Bind("locale") String locale,
            @Bind("description") String description,
            @Bind("organizationId") int organizationId);

    @Query(
            "update purchase_context_field_description set description = :description where field_configuration_id_fk = :fieldConfigurationId and field_locale = :locale")
    ...
    @Query(
            "select distinct lower(field_name) from purchase_context_field_configuration where lower(field_name) in (:fieldNames) and event_id_fk = :eventId")
