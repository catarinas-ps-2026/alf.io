...
public interface PollRepository {
    ...
    Optional<Poll> findSingleActiveForEvent(@Bind("eventId") int eventId, @Bind("id") Long pollId);
    ...
    @Query(INSERT_OPTION)
    @AutoGeneratedKey("id")
    AffectedRowCountAndKey<Long> insertOption(
            @Bind("pollId") Long pollId,
            @Bind("title") @JSONData Map<String, String> title,
            @Bind("description") @JSONData Map<String, String> description,
    ...
    @Query(
            ...
            value =
                    "update poll_option set title = :title::jsonb, description = :description::jsonb where id = :id and poll_id_fk = :pollId")
