...
public interface UserRepository {
    ...
    @Query(
            "select id from ba_user join j_user_organization on ba_user.id = j_user_organization.user_id where j_user_organization.org_id = :orgId and ba_user.username = :apiKey and ba_user.user_type = 'API_KEY'")
    ...
    @Query(
            ...
            """)
    @AutoGeneratedKey("id")
    AffectedRowCountAndKey<Integer> create(
            ...
            @Bind("userType") User.Type userType,
    ...
    @Query(
        ...
        """)
    int createPublicUserIfNotExists(
            @Bind("username") String username,
            @Bind("password") String password,
            @Bind("first_name") String firstname,
            @Bind("last_name") String lastname,
    ...
    @Query(
            "update ba_user set first_name = :firstName, last_name = :lastName, email_address = :emailAddress where id = :id")
    int updateContactInfo(
            @Bind("id") int id,
            @Bind("firstName") String firstName,
            @Bind("lastName") String lastName,
            @Bind("emailAddress") String emailAddress);
    ...
    @Query(
            "update ba_user set enabled = false, email_address = :newEmail, username = :newEmail, first_name = 'Deleted', last_name = 'Deleted' where id = :userId")
