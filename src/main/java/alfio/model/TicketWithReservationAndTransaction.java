...
public class TicketWithReservationAndTransaction {
    ...
    public TicketWithReservationAndTransaction(
            @Column("t_id") Integer id,
            ...
            @Column("tr_invoicing_additional_information") @JSONData
        ...
        this.ticketReservation = new TicketReservation(
                trId,
                validity,
                trStatus,
                trFullName,
                ...
                reservationFinalPriceCts,
                reservationVatCts,
                reservationDiscountCts,
        ...
        if (btId != null) {
            this.transaction = Optional.of(new Transaction(
                    btId,
                    transactionId,
                    paymentId,
                    reservationId,
                    ...
                    description,
                    paymentProxy,
                    Optional.ofNullable(platformFee).orElse(0L),
                    Optional.ofNullable(gatewayFee).orElse(0L),
                    transactionStatus,
                    metadata));
        } else {
