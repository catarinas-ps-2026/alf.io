...
public class DetailedScanData {
    ...
    public DetailedScanData(
            @Column("t_id") int ticketId,
        ...
        this.ticket = new Ticket(
                ...
                ticketVatStatus);
        this.sponsorScan =
                new SponsorScan(scanUserId, scanTimestamp, scanEventId, scanTicketId, notes, leadStatus, operator);
    }
}
